 ...
 */
export function StopAndThink({ children, className }: { children: React.ReactNode; className?: string }) {
  return (
    <div className={cn("border-y-2 border-petrol-500/30 bg-navy-950 py-10", className)}>
