 ...
 * stations and 60% of sales volume), not individual retailer figures, and
...
export const cmaPassThroughFindings = {
  ...
  nextReport: "A more detailed assessment of pass-through timeliness, and of local and regional price variation, is due in the CMA's Autumn 2026 report (not yet published as of 19 September 2026).",
};
