...
export default async function ResourcesPage() {
  ...
  return (
    <>
      ...
      <section id="check-the-claim" className="scroll-mt-24 bg-slate-50 py-14 sm:py-16">
        <Container>
          <div className="mx-auto max-w-3xl">
            <SectionHeading
              eyebrow="Check the claim"
              title="What do the figures actually show?"
              description="Pick a common claim about fuel prices and see the relevant official figures, with dates, context and sources. No verdicts: just the evidence and its limits."
            />
            <div className="mt-8">
              <ClaimChecker claims={claims} />
            </div>
          </div>
        </Container>
      </section>
